...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--ablation_loss', type=str, default='full', choices=['full', 'ce', 'ins2ins', 'ins2cls', 'exclude_ins2ins', 'exclude_ins2cls', 'exp_triplet_ins2cls', 'triplet_only', 'hierarchical_triplet_only', 'exp_hierarchical_triplet_ins2cls', 'qwk_hierarchical_triplet'], help='which loss components to use for ablation study')
