...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--ablation_loss', type=str, default='full', choices=['full', 'ce', 'ins2ins', 'ins2cls', 'exclude_ins2ins', 'exclude_ins2cls'], help='which loss components to use for ablation study')
