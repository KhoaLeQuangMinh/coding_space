...
def run_fold(opt, current_fold):
    ...
    # dataset preparation
    return_4c = (opt.class_num == 4) or (opt.ablation_loss in ['triplet_pole_intra', 'triplet_pole_intra_dist', 'triplet_only_global', 'triplet_pole_intra_dist_global', 'triplet_pole_intra_dist_global_sep', 'triplet_pole_intra_dist_sep'])
