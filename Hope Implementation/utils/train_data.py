...
def train_data(model, total_cn_loader, total_ad_loader, total_mci_loader,
    ...
    for e in tqdm(range(1, epochs + 1)):
        ...
        for ii, batch_ad in enumerate(total_ad_loader):
            ...
            # basic computing
            compactness_loss, separation_loss, mus, triplet_ins2cls, hierarchical_triplet_ins2cls, three_pole_local, three_pole_global, collinear_loss, P_prime, intra_pole_loss = basiccomputing(features, labels, labels_4c, global_protos)
            ...
            if ablation_loss in ['exp_triplet_ins2cls', 'triplet_only', 'triplet_only_collinear', 'triplet_only_sigreg', 'triplet_pole_intra']:
